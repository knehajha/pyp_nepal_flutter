...
class _PunchInDtails extends  State<StatefulWidget>{
  ...
  Widget build(BuildContext context) {
    ...
    String punchType = "IN";
    return  Scaffold(
        appBar: AppBar(title: const Text("Attendance Goal"),),
        body: Column(
          children: [
            Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  print("obfdsfdfdject");
                                  setState(() {
                                    print("obfdsfdfdject$punchType");
                                    punchType = punchType == "IN" ? "OUT" : "IN";
                                  });
                                  },
                                child: punchType == "IN" ?  Text("PUNCH IN",
                                    style: GoogleFonts.publicSans(color: Colors.black, fontWeight: FontWeight.w600),) :  Text("PUNCH OUT",style: GoogleFonts.publicSans(color: Colors.black, fontWeight: FontWeight.w600),),
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("Date", style: GoogleFonts.publicSans(color:Colors.black, fontSize: 14, fontWeight: FontWeight.w700),),
                    Text("Punch In", style: GoogleFonts.publicSans(color:Colors.black, fontSize: 14, fontWeight: FontWeight.w700),),
                    Text("Punch Out", style: GoogleFonts.publicSans(color:Colors.black, fontSize: 14, fontWeight: FontWeight.w700),),
                    Text("Punch Type", style: GoogleFonts.publicSans(color:Colors.black, fontSize: 14, fontWeight: FontWeight.w700),),
                 ...
                 //   color: ColorConstants.backgroundGray,
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("12/01/2023", style: GoogleFonts.publicSans(color:const Color(0xff464646), fontSize: 14, fontWeight: FontWeight.w500),),
                          Text("08:30 A.M.", style: GoogleFonts.publicSans(color:const Color(0xff464646), fontSize: 14, fontWeight: FontWeight.w500),),
                          Text("6.06 P.M.", style: GoogleFonts.publicSans(color:const Color(0xff464646), fontSize: 14, fontWeight: FontWeight.w500),),
                          Text("Self", style: GoogleFonts.publicSans(color:const Color(0xff464646), fontSize: 14, fontWeight: FontWeight.w500),),
