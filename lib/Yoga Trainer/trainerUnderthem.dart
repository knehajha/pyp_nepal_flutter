...
class TrainerUnder extends StatefulWidget {
  const TrainerUnder({Key? key}) : super(key: key);

  @override
  State<TrainerUnder> createState() => _TrainerUnderState();
}

class _TrainerUnderState extends State<TrainerUnder> {


  void _openWhatsAppChat()async{
    String ph = "";
    var url = Uri.parse("https://wa.me/$ph?text='hello world");
                                    ...
                                    child: TextButton(
                                      ...
                                      style: TextButton.styleFrom(
                                          shape: RoundedRectangleBorder(
                                            ...
                                            side:  BorderSide(color:  ColorConstants.kSecondaryColor,width: 3.0),
                                          ),
